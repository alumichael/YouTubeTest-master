package com.mike4christ.youtubetest;
...
public class MainActivity extends YouTubeBaseActivity implements OnInitializedListener, View.OnClickListener {
    private static final String TAG = MainActivity.class.getSimpleName();

    public static final String API_KEY = "AIzaSyCKZGU9bg_aru7mlMiM5vBQQ4uk3aLgIFo";

    //https://www.youtube.com/watch?v=<VIDEO_ID>
    public static final String VIDEO_ID = "_O0PPD1Xfbk";
